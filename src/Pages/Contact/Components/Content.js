      ...
      <div className="container">
        <div className="faqs">
          ...
          <div className="faqList">
            ...
            <div className="qaList">
              <div className="qaDiv">
                <h3>
                  Q: How do clients request for Free Seedlings/Planting
                  Materials?
                </h3>
                <div className="answer">
                  ...
                  <p>
                    ...
                    formal request letter addressed to the Office of the
                    Regional Executive Director (ORED) containing the following
                    information: (a) Name, address, and contact details of the
                    requestee; (b) Type and quantity of seedlings; and, (c)
                    Purpose of request. The request letter may be hand carried
                    or sent to denrncrored@gmail.com
                  </p>
                </div>
              ...
              <div className="qaDiv">
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    the scheduled visit and/or conduct of activity. Processing
                    of requests are done during official working hours/days.
                  </p>
                </div>
                <h3>
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    Yes. But visitors are required to strictly follow rules
                    while in LPPWP.
                  </p>
                </div>
                <h3>
              ...
              <div className="qaDiv">
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    wildlife (fauna) species: <br />
                    (a) If wildlife species was acquired from wildlife
                    permittees of DENR-NCR (Wildlife Farm Permittees and
                    Certificate of Wildlife Registration holders with updated
                    quarterly breeding report supporting that the wildlife
                    species disposed are progenies of registered wildlife
                    species), the client is required to submit their Sales
                    Invoice/ Official Receipt and Notarized Deed of Sale/ Deed
                    of Donation;
                    <br />
                ...
                <h3>
                  Q: Do clients need to bring the wildlife species to the WRPS
                  for inspection?
                </h3>
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    ...
                    necessary, hence, if it’s feasible we encourage the client
                    to bring the wildlife to the Office to verify/validate the
                    actual species being applied. If in case client cannot bring
                    the wildlife to the office for inspection (for whatever
                    valid reasons: e.g., number of heads, location, etc.),
                    on-site inspection will be considered.
                  </p>
                </div>
                <h3>
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    Inspection is done at the facility/residence of the
                    applicant)
                  </p>
                </div>
              </div>
            ...
            <div className="qaList">
              <div className="qaDiv">
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    The following are the requirements for the issuance of an
                    LTP:
                    <br />
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    necessary, hence, if it’s feasible we encourage the client
                    to bring the wildlife to the Office to verify/validate the
                    actual species being applied. <br />
                    <br />
                    If in case client cannot bring the wildlife to the office
                    for inspection (for whatever valid reasons: e.g., number of
                    heads, location, etc.), on-site inspection will be
                    considered.
                  </p>
                </div>
                <h3>
            ...
            <div className="qaList">
              <div className="qaDiv">
                <h3>
                  Q: What are the requirements for the issuance of a Tree
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    (2) Endorsement or Certificate of No Objection from
                    concerned Local Government Unit (Barangay/City or Municipal
                    Hall); <br />
                    (3) If land concerned is privately owned, copy of Original
                    Certificate of Title/Transfer Certificate of Title (1
                    certified copy or 1 photocopy with accompanying owner’s
                    copy); <br />
                    (4) If requesting party is school/organization, PTA
                    Resolution or Resolution from any organized group stating No
                    Objection and Reason for Cutting (1 original); and <br />
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    There is no charge for Tree Cutting/Pruning/Balling Permit
                    but every tree approved for cutting must be replaced with 50
                    seedlings if planted and 100 seedlings if naturally grown.
                  </p>
                </div>
                <h3>
                  Q: How much is the seedlings? Can clients pay in cash instead
            ...
            <div className="qaList">
              <div className="qaDiv">
                ...
                <h3>
                  Q: Does DENR-NCR provide cutting/pruning/earthballing
                  services?
                </h3>
                <div className="answer">
                  <h3>A:</h3>
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    Violation of any conditions in the permit shall be
                    sufficient ground for its cancellation/revocation without
                    prejudice to the imposition of penalties in accordance with
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    logs will be given to the owner. Otherwise, the cut logs
                    will be turned over to the DENR-NCR for proper disposition.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="qaList">
              <div className="qaDiv">
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    To the Enforcement Division at telephone number 8420-6744,
                    or to enforcementdivision20@gmail.com, or to the Field
                    Offices of the DENR-NCR. The Office is mandated to protect
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    the Chief, Enforcement Division. The Chief then evaluates
                    and refers the matter to the Surveillance and Intelligence
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    complaint. Clients may also contact the office for the
                    status of his/her complaint.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="qaList">
              <div className="qaDiv">
                ...
                <div className="answer">
                  <h3>A:</h3>
                  <p>
                    Consider safety first. Never attempt to handle wildlife
                    unless you are certain that you can do so, without any harm
                    to yourself or to the wildlife. You can immediately call the
              ...
              <div className="qaDiv">
                ...
                <div className="answer">
                  ...
                  <p>
                    ...
                    (3) Proof of Legal Source (Official Receipt/Sales
                    Invoice/Deed of Sale/ Donation/Exchange, Local Transport
                    Permit (LTP)) if applicable No fees required.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="contact">
          <div className="branches">
            <h1>Information</h1>
            <div className="DENR">
              <h2 className="collapsible" onClick={handleClick}>
            ...
            <div className="BMB" onClick={handleClick}>
